...
- NUNCA permitas conversiones LF (\n) - rompen consistencia del código
- Antes de modificar archivos, verifica git config:
  - `git config core.autocrlf true`
  - `git config core.eol crlf`
- Si detectas cambios LF en diffs, PARA y arregla git config primero
- Todos los archivos texto (.cs, .ts, .js, .json, .md) deben mantener CRLF
...
- NUNCA incluyas "Generated with Claude Code"
- NUNCA incluyas "Co-Authored-By: Claude"
- NUNCA menciones copiloto, AI, o asistencia artificial
- NUNCA uses emojis en commits
- Todos los commits deben mostrar a Bernard como único contribuidor
- Sin atribución de IA en el historial de commits
- Formato profesional convencional: `fix:`, `feat:`, `refactor:`, etc.
