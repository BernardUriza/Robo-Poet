...
def demo_multi_corpus_system():
    ...
    print("   [SPARK] Vocabulario más rico y diverso")
    print("   [SPARK] Estilos múltiples en un solo modelo")
    print("   [SPARK] Mayor capacidad de generalización")
    print("   [SPARK] Textos generados más interesantes")
    print()
    ...
    print("[FAST] VENTAJAS DEL MULTI-CORPUS:")
    print("-" * 40)
