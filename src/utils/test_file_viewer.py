...
def test_file_viewer():
    ...
    print("\n1️⃣ TEST: ESCÁNER RÁPIDO")
    print("-" * 40)
    result = quick_file_scan()
    print(result)
    
    # Test 2: FileViewer completo
    print("\n2️⃣ TEST: FILEVIEWER COMPLETO")
    print("-" * 40)
    viewer = FileViewer()
    ...
    for log in recent_logs[:3]:
        print(f"  📝 {log['name']} - {log['modified_human']}")
    
    # Test 4: Visualizaciones
    print("\n4️⃣ TEST: ANÁLISIS DE VISUALIZACIONES")
    print("-" * 40)
    ...
    if visualizations:
        ...
        for viz in visualizations:
            ...
            print(f"  📈 {viz['name']} - {viz_info.get('type', 'Unknown')}")
    else:
        print("📭 No se encontraron visualizaciones")
    
    # Test 5: Reportes detallados
    print("\n5️⃣ TEST: ANÁLISIS DE REPORTES")
    print("-" * 40)
    ...
    if visualizations:
        print("\n6️⃣ TEST: COMANDOS DE APERTURA DE IMÁGENES")
        print("-" * 40)
        
        import os
        
        print("💻 COMANDOS PARA ABRIR VISUALIZACIONES:")
    ...
    print("✅ Sistema de visualización funcionando correctamente")
...
def demo_interactive_usage():
    ...
    print("🎯 FUNCIONALIDADES DISPONIBLES EN LA UI:")
    print()
    print("📝 EXPLORADOR DE LOGS (Opción A):")
    ...
    print()
    print("📈 EXPLORADOR DE VISUALIZACIONES (Opción B):")
    ...
    print()
    print("💡 COMANDOS PARA GENERAR ARCHIVOS:")
    ...
    print()
    print("🔧 UNA VEZ CON DEPENDENCIAS INSTALADAS:")
