...
def create_character_vocabulary(text_path: str, output_path: str) -> Tuple[Dict[str, int], Dict[int, str]]:
    ...
    """
    print(f"[BOOKS] Creating character vocabulary from {text_path}")
    ...
    print(f"[ABC] Unique characters: {len(unique_chars)}")
    ...
    print(f"[TARGET] Total vocabulary size: {vocab_size}")
    
    # Count character frequencies for analysis
    char_counts = Counter(text)
    top_chars = char_counts.most_common(10)
    print(f"[CHART] Most frequent characters:")
...
if __name__ == "__main__":
    ...
    print("\n[OK] Character vocabulary creation completed!")