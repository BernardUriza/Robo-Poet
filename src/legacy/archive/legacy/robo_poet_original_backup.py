...
╰─────────────────────────────────────────────────╯""")
    ...
    def quick_generation(self, generator):
        ...
        presets = {
            ...
            '2': {'name': '[SPARK] Creativo (Balanceado)', 'temp': 0.8, 'length': 250},
    ...
    def display_generation_result(self, result: str, seed: str, temperature: float, length: int, gen_time: float):
        ...
        print(result)
        print("-" * 60)
        print(f"[FAST] Velocidad: {len(result)/gen_time:.0f} chars/segundo")
    ...
    def multi_seed_experiment(self, generator):
        ...
        for i, seed in enumerate(seeds, 1):
            ...
            print(result)
            print(f"[FAST] {len(result)} chars en {gen_time:.1f}s")
    ...
    def show_experiment_summary(self, results, variable_type):
        ...
        print(f"   [FAST] Velocidad promedio: {total_chars/total_time:.0f} chars/s")
